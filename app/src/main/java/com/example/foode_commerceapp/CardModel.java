...
//    String cardIMG;
    ...
    public CardModel(int cardIMG,String cardTITLE,String ratingOFFOOD,String dishNAME,String foodDESTINATION,String foodPRICE,String forNUMMBERpeople,String deliveryTIME,String distance,String ID){
...
//        return cardIMG;
//    }
    public void setcardIMG(int pic){
        this.cardIMG = cardIMG;
    }
